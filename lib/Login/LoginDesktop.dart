...
class LoginDesktop extends StatefulWidget {
  ...
  const LoginDesktop(this.loginProvider);
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            CustomText(
              text:
                  'You can use your phone number or go back and sign in with google',
              fontSize: 16,
              weight: FontWeight.bold,
            ...
            SizedBox(
                width: 400,
                //padding: EdgeInsets.symmetric(vertical: 10, horizontal: 900),
